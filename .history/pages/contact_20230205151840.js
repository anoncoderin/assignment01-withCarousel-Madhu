...
function validateFirstName(inputdata)
{
    if((inputdata != null) && ((inputdata.toString() === '') || inputdata.toString().match(/^[A-Z][a-z]*$/))){
        document.getElementById('errorMessage').innerHTML='';
    }
    else{
        document.getElementById('FirsterrorMessage').innerHTML='First name error: first name must be capital. Must use alphabets only.';
    }
}

function validateLastName(inputdata)
{
    if((inputdata != null) && ((inputdata.toString() === '') || inputdata.toString().match(/^[A-Z][a-z]*$/))){
        document.getElementById('errorMessage').innerHTML='';
    }
    else{
        document.getElementById('errorMessage').innerHTML='Last name error: last name must be capital. Must use alphabets only.';
    }
}
                ...
                <div className={styles.contactinfoname}>
                    <div className={styles.contactinfofirst}>
                        ...
                        <input
                            ...
                            onChange={
                                    (x => {
                                    validateFirstName(x.target.value);
