...
{
    if((inputdata != null || inputdata) && inputdata.toString().match(/^[A-Z][a-z]*$/)){
        document.getElementById('errorMessage').innerHTML='';
    }
    else{
        document.getElementById('errorMessage').innerHTML='First name error: first name must be capital. Must use alphabets onplay.';
    }
}
