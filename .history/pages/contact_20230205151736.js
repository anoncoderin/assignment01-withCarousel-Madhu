...
function validateFirstName(inputdata)
{
    if((inputdata != null) && ((inputdata.toString() === '') || inputdata.toString().match(/^[A-Z][a-z]*$/))){
        ...
        document.getElementById('errorMessage').innerHTML='First name error: first name must be capital. Must use alphabets only.';
    }
}
...
function validateLastName(inputdata)
{
    if((inputdata != null) && ((inputdata.toString() === '') || inputdata.toString().match(/^[A-Z][a-z]*$/))){
        ...
        document.getElementById('errorMessage').innerHTML='Last name error: first name must be capital. Must use alphabets only.';
    }
}
