  ...
  return (
    <>
      ...
      <div className={styles.content}>
        ...
        <br></br>
        <h5>
        Big info is the largest program expo and information session at BCIT. It's your chance to find out about all the programs- from business, computing, health to engineering, trades, and applied
        </h5>
      </div>
