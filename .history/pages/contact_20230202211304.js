...
<div className={styles.backimage}>
      ...
      <div className={styles.nav}>
            <button className={styles.menubar} onClick={handleClick}><Image src='/images/icons/icons/menu-icon.png' height={45} width={45}></Image></button>
            <Image id="test" src='/images/favicon/favicon.png' height={50} width={50}></Image>
