  ...
  return (
    <div>
      <div className={styles.nav}>
        ...
        {isOpen && (
          <div><div className={styles.togglebutton}>
            <Image src={'/images/menuBackground.png'} onClick={toggleMenu} height={250} width={250}></Image>
            
          </div>
          <Link href="index"><button className={styles.buttontoggle}>Home</button></Link>
          <Link href="about"><button className={styles.buttontoggle}>About</button></Link>
            <Link href="contact"><button className={styles.buttontoggle}>Contact</button></Link>
          </div>
        )}
